...
export const metadata: Metadata = {
  title: 'Pays-Bas - Japon en Direct: Coupe du Monde 2026 Streaming',
  description: 'Pays-Bas - Japon en direct à la Coupe du Monde 2026, dimanche 14 juin 2026. Coup d\'envoi 22:00 CEST. Guide streaming complet, chaînes TV, gratuit.',
  openGraph: {
    title: 'Pays-Bas - Japon en Direct: Coupe du Monde 2026 Streaming',
    description: 'Pays-Bas - Japon en direct à la Coupe du Monde 2026, dimanche 14 juin 2026. Coup d\'envoi 22:00 CEST. Guide streaming complet, chaînes TV, gratuit.',
    type: 'article',
    locale: 'fr_BE',
    url: 'https://www.iptv2belgie.be/coupe-du-monde-2026/pays-bas-vs-japon',
  },
  alternates: {
    canonical: 'https://www.iptv2belgie.be/coupe-du-monde-2026/pays-bas-vs-japon',
  },
};

const sportsEventSchema = {"@context": "https://schema.org", "@type": "SportsEvent", "name": "Pays-Bas vs Japon - FIFA World Cup 2026", "startDate": "2026-06-14T20:00:00Z", "eventStatus": "https://schema.org/EventScheduled", "competitor": [{"@type": "SportsTeam", "name": "Pays-Bas"}, {"@type": "SportsTeam", "name": "Japon"}], "url": "https://www.iptv2belgie.be/coupe-du-monde-2026/pays-bas-vs-japon"};
const faqSchema = {"@context": "https://schema.org", "@type": "FAQPage", "mainEntity": [{"@type": "Question", "name": "À quelle heure commence Pays-Bas - Japon ?", "acceptedAnswer": {"@type": "Answer", "text": "Le match débute le dimanche 14 juin 2026 à 22:00 heure belge (CEST)."}}, {"@type": "Question", "name": "Sur quelle chaîne regarder Pays-Bas - Japon ?", "acceptedAnswer": {"@type": "Answer", "text": "En Belgique : RTBF (français, Auvio gratuit) et VRT 1 (néerlandais, VRT MAX gratuit). Notre service IPTV propose tous les flux officiels de la Coupe du Monde en HD/4K."}}, {"@type": "Question", "name": "Peut-on regarder Pays-Bas - Japon gratuitement ?", "acceptedAnswer": {"@type": "Answer", "text": "Oui en Belgique, RTBF et VRT diffusent gratuitement via Auvio et VRT MAX. Pour accéder à tous les matchs et flux internationaux, un abonnement IPTV reste l'option la plus fiable."}}, {"@type": "Question", "name": "Notre service IPTV fonctionne sur Smart TV et Firestick ?", "acceptedAnswer": {"@type": "Answer", "text": "Oui. Notre service fonctionne sur tous les appareils courants : Smart TV (Samsung, LG, Android TV), Firestick, smartphones, tablettes, boîtiers MAG. Activation en moins de 10 minutes."}}, {"@type": "Question", "name": "Y a-t-il une garantie ?", "acceptedAnswer": {"@type": "Answer", "text": "Oui, garantie satisfait ou remboursé de 30 jours, sans condition. Sans engagement."}}]};
    ...
    <>
      ...
      <article className="max-w-4xl mx-auto px-6 py-12 bg-slate-900 text-white min-h-screen">
        <nav className="mb-8 text-sm text-gray-400">
          ...
          <span className="mx-2">→</span>
          <span className="text-white">Pays-Bas - Japon</span>
        </nav>
        <header className="mb-10">
          <h1 className="text-3xl md:text-5xl font-bold mb-6 bg-gradient-to-r from-sky-400 to-emerald-400 bg-clip-text text-transparent">
            Pays-Bas - Japon en Direct: Coupe du Monde 2026
          </h1>
          <p className="text-xl text-gray-300 leading-relaxed">Pays-Bas affronte Japon.</p>
        </header>
        ...
        <h2 className="text-2xl font-bold mt-12 mb-4">Où regarder Pays-Bas - Japon</h2>
        ...
        <div className="bg-gradient-to-br from-sky-900/30 to-emerald-900/20 border border-sky-500/30 rounded-2xl p-6 mb-10">
          <h2 className="text-2xl font-bold mb-3">Regarder Pays-Bas - Japon gratuitement en ligne</h2>
          ...
          <a href="https://wa.me/33773436514?text=Bonjour!%20Je%20voudrais%20regarder%20Pays-Bas%20-%20Japon%20en%20direct%20à%20la%20Coupe%20du%20Monde%202026" className="inline-block bg-emerald-500 hover:bg-emerald-600 text-white font-semibold px-6 py-3 rounded-lg transition-colors">Accès instantané via WhatsApp →</a>
        ...
        <p className="text-gray-300 mb-4">Ronald Koeman dirige Pays-Bas pour le match CdM 2026 contre Japon. </p>
        <h3 className="text-lg font-semibold text-sky-400 mt-6 mb-2">Japon</h3>
        <p className="text-gray-300 mb-4">Hajime Moriyasu dirige Japon pour le match CdM 2026 contre Pays-Bas. </p>

        <h2 className="text-2xl font-bold mt-12 mb-6">Questions fréquentes</h2>
        <div className="space-y-4">
          <div className="bg-slate-800 border border-slate-700 rounded-xl p-5">
            <h3 className="text-lg font-semibold text-sky-400 mb-2">À quelle heure commence Pays-Bas - Japon ?</h3>
            <p className="text-gray-300">Le match débute le dimanche 14 juin 2026 à 22:00 heure belge (CEST).</p>
          </div>
          <div className="bg-slate-800 border border-slate-700 rounded-xl p-5">
            <h3 className="text-lg font-semibold text-sky-400 mb-2">Sur quelle chaîne regarder Pays-Bas - Japon ?</h3>
          ...
          <div className="bg-slate-800 border border-slate-700 rounded-xl p-5">
            <h3 className="text-lg font-semibold text-sky-400 mb-2">Peut-on regarder Pays-Bas - Japon gratuitement ?</h3>
        ...
        <div className="mt-12 pt-8 border-t border-slate-700">
          <a href="https://wa.me/33773436514?text=Bonjour!%20Je%20voudrais%20regarder%20Pays-Bas%20-%20Japon%20en%20direct%20à%20la%20Coupe%20du%20Monde%202026" className="inline-block bg-emerald-500 hover:bg-emerald-600 text-white font-semibold px-6 py-3 rounded-lg transition-colors">Commander via WhatsApp →</a>
        </div>
      </article>
    </>
  );
