...
export const metadata: Metadata = {
  title: 'Japon - Suède en Direct: Coupe du Monde 2026 Streaming',
  description: 'Japon - Suède en direct à la Coupe du Monde 2026, jeudi 25 juin 2026. Coup d\'envoi 01:00 CEST. Guide streaming complet, chaînes TV, gratuit.',
  openGraph: {
    title: 'Japon - Suède en Direct: Coupe du Monde 2026 Streaming',
    description: 'Japon - Suède en direct à la Coupe du Monde 2026, jeudi 25 juin 2026. Coup d\'envoi 01:00 CEST. Guide streaming complet, chaînes TV, gratuit.',
    type: 'article',
    locale: 'fr_BE',
    url: 'https://www.iptv2belgie.be/coupe-du-monde-2026/japon-vs-suede',
  },
  alternates: {
    canonical: 'https://www.iptv2belgie.be/coupe-du-monde-2026/japon-vs-suede',
  },
};

const sportsEventSchema = {"@context": "https://schema.org", "@type": "SportsEvent", "name": "Japon vs Suède - FIFA World Cup 2026", "startDate": "2026-06-25T23:00:00Z", "eventStatus": "https://schema.org/EventScheduled", "competitor": [{"@type": "SportsTeam", "name": "Japon"}, {"@type": "SportsTeam", "name": "Suède"}], "url": "https://www.iptv2belgie.be/coupe-du-monde-2026/japon-vs-suede"};
const faqSchema = {"@context": "https://schema.org", "@type": "FAQPage", "mainEntity": [{"@type": "Question", "name": "À quelle heure commence Japon - Suède ?", "acceptedAnswer": {"@type": "Answer", "text": "Le match débute le jeudi 25 juin 2026 à 01:00 heure belge (CEST)."}}, {"@type": "Question", "name": "Sur quelle chaîne regarder Japon - Suède ?", "acceptedAnswer": {"@type": "Answer", "text": "En Belgique : RTBF (français, Auvio gratuit) et VRT 1 (néerlandais, VRT MAX gratuit). Notre service IPTV propose tous les flux officiels de la Coupe du Monde en HD/4K."}}, {"@type": "Question", "name": "Peut-on regarder Japon - Suède gratuitement ?", "acceptedAnswer": {"@type": "Answer", "text": "Oui en Belgique, RTBF et VRT diffusent gratuitement via Auvio et VRT MAX. Pour accéder à tous les matchs et flux internationaux, un abonnement IPTV reste l'option la plus fiable."}}, {"@type": "Question", "name": "Notre service IPTV fonctionne sur Smart TV et Firestick ?", "acceptedAnswer": {"@type": "Answer", "text": "Oui. Notre service fonctionne sur tous les appareils courants : Smart TV (Samsung, LG, Android TV), Firestick, smartphones, tablettes, boîtiers MAG. Activation en moins de 10 minutes."}}, {"@type": "Question", "name": "Y a-t-il une garantie ?", "acceptedAnswer": {"@type": "Answer", "text": "Oui, garantie satisfait ou remboursé de 30 jours, sans condition. Sans engagement."}}]};
    ...
    <>
      ...
      <article className="max-w-4xl mx-auto px-6 py-12 bg-slate-900 text-white min-h-screen">
        <nav className="mb-8 text-sm text-gray-400">
          ...
          <span className="mx-2">→</span>
          <span className="text-white">Japon - Suède</span>
        </nav>
        <header className="mb-10">
          <h1 className="text-3xl md:text-5xl font-bold mb-6 bg-gradient-to-r from-sky-400 to-emerald-400 bg-clip-text text-transparent">
            Japon - Suède en Direct: Coupe du Monde 2026
          </h1>
          <p className="text-xl text-gray-300 leading-relaxed">Japon affronte Suède.</p>
        </header>
        ...
        <h2 className="text-2xl font-bold mt-12 mb-4">Où regarder Japon - Suède</h2>
        ...
        <div className="bg-gradient-to-br from-sky-900/30 to-emerald-900/20 border border-sky-500/30 rounded-2xl p-6 mb-10">
          <h2 className="text-2xl font-bold mb-3">Regarder Japon - Suède gratuitement en ligne</h2>
          ...
          <a href="https://wa.me/33773436514?text=Bonjour!%20Je%20voudrais%20regarder%20Japon%20-%20Suède%20en%20direct%20à%20la%20Coupe%20du%20Monde%202026" className="inline-block bg-emerald-500 hover:bg-emerald-600 text-white font-semibold px-6 py-3 rounded-lg transition-colors">Accès instantané via WhatsApp →</a>
        ...
        <h3 className="text-lg font-semibold text-sky-400 mt-6 mb-2">Japon</h3>
        <p className="text-gray-300 mb-4">Hajime Moriyasu dirige Japon pour le match CdM 2026 contre Suède. </p>
        <h3 className="text-lg font-semibold text-sky-400 mt-6 mb-2">Suède</h3>
        <p className="text-gray-300 mb-4">Graham Potter dirige Suède pour le match CdM 2026 contre Japon. </p>

        <h2 className="text-2xl font-bold mt-12 mb-6">Questions fréquentes</h2>
        <div className="space-y-4">
          <div className="bg-slate-800 border border-slate-700 rounded-xl p-5">
            <h3 className="text-lg font-semibold text-sky-400 mb-2">À quelle heure commence Japon - Suède ?</h3>
            <p className="text-gray-300">Le match débute le jeudi 25 juin 2026 à 01:00 heure belge (CEST).</p>
          </div>
          <div className="bg-slate-800 border border-slate-700 rounded-xl p-5">
            <h3 className="text-lg font-semibold text-sky-400 mb-2">Sur quelle chaîne regarder Japon - Suède ?</h3>
          ...
          <div className="bg-slate-800 border border-slate-700 rounded-xl p-5">
            <h3 className="text-lg font-semibold text-sky-400 mb-2">Peut-on regarder Japon - Suède gratuitement ?</h3>
        ...
        <div className="mt-12 pt-8 border-t border-slate-700">
          <a href="https://wa.me/33773436514?text=Bonjour!%20Je%20voudrais%20regarder%20Japon%20-%20Suède%20en%20direct%20à%20la%20Coupe%20du%20Monde%202026" className="inline-block bg-emerald-500 hover:bg-emerald-600 text-white font-semibold px-6 py-3 rounded-lg transition-colors">Commander via WhatsApp →</a>
        </div>
      </article>
    </>
  );
