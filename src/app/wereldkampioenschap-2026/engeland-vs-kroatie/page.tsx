...
export const metadata: Metadata = {
  title: 'Engeland - Kroatië Live Kijken: WK 2026 Gratis Stream',
  description: 'Engeland - Kroatië live kijken op het WK 2026, woensdag 17 juni 2026. Aftrap 22:00 CEST. Volledige streamgids, tv-kanalen, gratis online.',
  openGraph: {
    title: 'Engeland - Kroatië Live Kijken: WK 2026 Gratis Stream',
    description: 'Engeland - Kroatië live kijken op het WK 2026, woensdag 17 juni 2026. Aftrap 22:00 CEST. Volledige streamgids, tv-kanalen, gratis online.',
    type: 'article',
    locale: 'nl_BE',
    url: 'https://www.iptv2belgie.be/wereldkampioenschap-2026/engeland-vs-kroatie',
  },
  alternates: {
    canonical: 'https://www.iptv2belgie.be/wereldkampioenschap-2026/engeland-vs-kroatie',
  },
};

const sportsEventSchema = {"@context": "https://schema.org", "@type": "SportsEvent", "name": "Engeland vs Kroatië - FIFA World Cup 2026", "startDate": "2026-06-17T20:00:00Z", "eventStatus": "https://schema.org/EventScheduled", "competitor": [{"@type": "SportsTeam", "name": "Engeland"}, {"@type": "SportsTeam", "name": "Kroatië"}], "url": "https://www.iptv2belgie.be/wereldkampioenschap-2026/engeland-vs-kroatie"};
const faqSchema = {"@context": "https://schema.org", "@type": "FAQPage", "mainEntity": [{"@type": "Question", "name": "Hoe laat begint Engeland - Kroatië?", "acceptedAnswer": {"@type": "Answer", "text": "De wedstrijd begint op woensdag 17 juni 2026 om 22:00 Belgische tijd (CEST)."}}, {"@type": "Question", "name": "Op welk kanaal is Engeland - Kroatië te zien?", "acceptedAnswer": {"@type": "Answer", "text": "In België is de wedstrijd te volgen via RTBF (Franstalig, Auvio gratis) en VRT 1 (Nederlandstalig, VRT MAX gratis). Onze IPTV-dienst biedt alle officiële WK-feeds in HD/4K."}}, {"@type": "Question", "name": "Kan ik Engeland - Kroatië gratis kijken?", "acceptedAnswer": {"@type": "Answer", "text": "Ja, in België zijn RTBF en VRT gratis beschikbaar via Auvio en VRT MAX. Voor toegang tot alle WK-wedstrijden en internationale feeds is een IPTV-abonnement de meest betrouwbare keuze."}}, {"@type": "Question", "name": "Werkt onze IPTV-dienst op Smart TV en Firestick?", "acceptedAnswer": {"@type": "Answer", "text": "Ja. Onze service werkt op alle gangbare apparaten: Smart TV (Samsung, LG, Android TV), Firestick, smartphones, tablets en MAG-boxes. Activatie binnen 10 minuten."}}, {"@type": "Question", "name": "Is er garantie?", "acceptedAnswer": {"@type": "Answer", "text": "Ja, 30 dagen geld-terug-garantie zonder vragen. Geen contract, opzegbaar wanneer u wilt."}}]};
    ...
    <>
      ...
      <article className="max-w-4xl mx-auto px-6 py-12 bg-slate-900 text-white min-h-screen">
        <nav className="mb-8 text-sm text-gray-400">
          ...
          <span className="mx-2">→</span>
          <span className="text-white">Engeland - Kroatië</span>
        </nav>
        <header className="mb-10">
          <h1 className="text-3xl md:text-5xl font-bold mb-6 bg-gradient-to-r from-sky-400 to-emerald-400 bg-clip-text text-transparent">
            Engeland - Kroatië: WK 2026 Live Kijken
          </h1>
          <p className="text-xl text-gray-300 leading-relaxed">Engeland speelt tegen Kroatië.</p>
        </header>
        ...
        <h2 className="text-2xl font-bold mt-12 mb-4">Waar Engeland - Kroatië kijken</h2>
        ...
        <div className="bg-gradient-to-br from-sky-900/30 to-emerald-900/20 border border-sky-500/30 rounded-2xl p-6 mb-10">
          <h2 className="text-2xl font-bold mb-3">Engeland - Kroatië gratis online kijken</h2>
          ...
          <a href="https://wa.me/33773436514?text=Hoi!%20Ik%20wil%20Engeland%20-%20Kroatië%20live%20kijken%20op%20WK%202026" className="inline-block bg-emerald-500 hover:bg-emerald-600 text-white font-semibold px-6 py-3 rounded-lg transition-colors">Krijg direct toegang via WhatsApp →</a>
        ...
        <p className="text-gray-300 mb-4">Thomas Tuchel leidt Engeland in de WK 2026-wedstrijd tegen Kroatië. </p>
        <h3 className="text-lg font-semibold text-sky-400 mt-6 mb-2">Kroatië</h3>
        <p className="text-gray-300 mb-4">Zlatko Dalić leidt Kroatië in de WK 2026-wedstrijd tegen Engeland. </p>

        <h2 className="text-2xl font-bold mt-12 mb-6">Veelgestelde vragen</h2>
        <div className="space-y-4">
          <div className="bg-slate-800 border border-slate-700 rounded-xl p-5">
            <h3 className="text-lg font-semibold text-sky-400 mb-2">Hoe laat begint Engeland - Kroatië?</h3>
            <p className="text-gray-300">De wedstrijd begint op woensdag 17 juni 2026 om 22:00 Belgische tijd (CEST).</p>
          </div>
          <div className="bg-slate-800 border border-slate-700 rounded-xl p-5">
            <h3 className="text-lg font-semibold text-sky-400 mb-2">Op welk kanaal is Engeland - Kroatië te zien?</h3>
          ...
          <div className="bg-slate-800 border border-slate-700 rounded-xl p-5">
            <h3 className="text-lg font-semibold text-sky-400 mb-2">Kan ik Engeland - Kroatië gratis kijken?</h3>
        ...
        <div className="mt-12 pt-8 border-t border-slate-700">
          <a href="https://wa.me/33773436514?text=Hoi!%20Ik%20wil%20Engeland%20-%20Kroatië%20live%20kijken%20op%20WK%202026" className="inline-block bg-emerald-500 hover:bg-emerald-600 text-white font-semibold px-6 py-3 rounded-lg transition-colors">Bestel via WhatsApp →</a>
        </div>
      </article>
    </>
  );
